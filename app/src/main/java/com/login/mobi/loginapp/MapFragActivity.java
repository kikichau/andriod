...
import static com.login.mobi.loginapp.R.id.mapFrag;

public class MapFragActivity extends FragmentActivity implements OnMapReadyCallback, DiaryActivity.OnCurrentLocationChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DiaryActivity.setOnCurrentLocationChangeListener(this);
        mIsFirstLine = true;
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mLocation = DiaryActivity.mLastLocation;
